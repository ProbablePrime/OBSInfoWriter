...
void OutputFormatSRT::Start()
{
   ...
   std::string timestr = Groundfloor::TimestampToStr(c_TimestampNotation, Groundfloor::GetTimestamp())->getValue();
...
void OutputFormatSRT::ResumedMarker(const int64_t timestamp, const int64_t pauselength)
{
}
